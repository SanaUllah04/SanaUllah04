...
```mermaid
graph LR
    SU((SanaUllah)):::core --> FS[Full-Stack Engineering]
    SU --> AI[AI Integration]
    SU --> OPS[DevOps / Cloud]
    SU --> QC[Quantum Tinkering]
    SU --> BM[🦇 Nocturnal Activity]

    FS --> RJ[React / Next.js]
    FS --> NJ[Node.js / FastAPI / Django]
    AI --> AU[Automation via n8n]
    AI --> DB[MongoDB / Postgres / Supabase]
    OPS --> DK[Docker / Terraform]
    OPS --> CI[GitHub Actions / AWS EC2]
    QC --> QS[Qiskit / QAOA / VQE]
